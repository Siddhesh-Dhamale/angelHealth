...
<?php include("inc/header.php"); ?>
  <section class="pp_tnc-sec-01">
    <div class="container">
      <div class="row">
        <div class="col-md-8 mx-auto">
          <h2>Angel Health Center Privacy Policy</h2>
          <p>Your privacy is important to us. It is Angel Health Center's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://angelhealthcentre.com/">https://angelhealthcentre.com/</a>, and other sites we own and operate.</p>
          ...
          <p>All information, images, fonts, colors strictly belongs to Global Angel Health Care Private Limited</p>
          <p>This policy is effective as of March 19, 2024</p>
          
          <p>Last updated: March 19, 2024</p>
        </div>
        <div class="col-md-8 mx-auto">
          <div class="pp_tnc-container">
            <div class="pt_box">
            ...
            <div class="pt_box">
              ...
              <p>The types of sensitive information that we may collect about you include:</p>
              <ul>
            ...
            <div class="pt_box">
              ...
              <p><strong>Third parties we currently use include:</strong></p>
              <ul>
                <li>MDirector</li>
              </ul>
            </div>
            <div class="pt_box">
              ...
              <p><strong>Information from third parties:</strong> <br>
                If we receive personal information about you from a third party, we will protect it as set out in this privacy policy. If you are a third party providing personal information about somebody else, you represent and warrant that you have such person’s consent to provide the personal information to us.</p>
              <p><strong>Marketing permission:</strong> <br>
                If you have previously agreed to us using your personal information for direct marketing purposes, you may change your mind at any time by contacting us using the details below.</p>
              <p><strong>Access:</strong> <br>
                You may request details of the personal information that we hold about you.</p>
              ...
              <p><strong>Notification of data breaches:</strong> <br>
            ...
            <div class="pt_box">
              ...
              <p><a href="tel:+91 90042 64646">+91 90042 64646</a></p>
			  <p><a href="mailto:info@angelhealthcenter.com">info@angelhealthcenter.com</a></p>
            </div>
          </div>
        </div>
      </div>
